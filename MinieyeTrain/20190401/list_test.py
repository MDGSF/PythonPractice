...
class TestListSlice(unittest.TestCase):
    ...
    def test_slice(self):
        ...
        checkList(l[:2], [1, 2])
        checkList(l[:3], [1, 2, 3])
        checkList(l[:4], [1, 2, 3, 4])
        checkList(l[:5], [1, 2, 3, 4, 5])
        checkList(l[:6], [1, 2, 3, 4, 5])
        checkList(l[:100], [1, 2, 3, 4, 5])

        checkList(l[0:0], [])
        checkList(l[0:1], [1])
        checkList(l[0:2], [1, 2])
        checkList(l[0:3], [1, 2, 3])
        checkList(l[0:4], [1, 2, 3, 4])
        checkList(l[0:5], [1, 2, 3, 4, 5])
        checkList(l[0:6], [1, 2, 3, 4, 5])
        checkList(l[0:100], [1, 2, 3, 4, 5])

        checkList(l[1:0], [])
        checkList(l[1:1], [])
        checkList(l[1:2], [2])
        checkList(l[1:3], [2, 3])
        checkList(l[1:4], [2, 3, 4])
        checkList(l[1:5], [2, 3, 4, 5])
        checkList(l[1:6], [2, 3, 4, 5])
        checkList(l[1:100], [2, 3, 4, 5])
        ...
        checkList(l[2:3], [3])
        checkList(l[2:4], [3, 4])
        checkList(l[2:5], [3, 4, 5])
        checkList(l[2:6], [3, 4, 5])
        checkList(l[2:100], [3, 4, 5])
        ...
        checkList(l[-2:], [4, 5])
        checkList(l[-3:], [3, 4, 5])
        checkList(l[-4:], [2, 3, 4, 5])
        checkList(l[-5:], [1, 2, 3, 4, 5])
        checkList(l[-6:], [1, 2, 3, 4, 5])
        checkList(l[-100:], [1, 2, 3, 4, 5])

        checkList(l[:-1], [1, 2, 3, 4])
        checkList(l[:-2], [1, 2, 3])
        checkList(l[:-3], [1, 2])
        checkList(l[:-4], [1])
        checkList(l[:-5], [])
        ...
        checkList(l[-5:0], [])
        checkList(l[-5:-1], [1, 2, 3, 4])
        checkList(l[-5:-2], [1, 2, 3])
        checkList(l[-5:-3], [1, 2])
        checkList(l[-5:-4], [1])
        checkList(l[-5:-5], [])
        checkList(l[-5:-6], [])
